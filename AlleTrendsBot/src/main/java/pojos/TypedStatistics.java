...
public class TypedStatistics {
	...
	public void incrementBy(TypedStatistics statistics) {
		this.itemsCount += statistics.getItemsCount();
		this.biddersCount += statistics.getBiddersCount();
		this.bidsCount += statistics.getBidsCount();
		this.leftCount += statistics.getLeftCount();
		this.sale += statistics.getSale();
	}
}
