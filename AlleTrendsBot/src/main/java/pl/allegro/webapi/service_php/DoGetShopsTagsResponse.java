...
public class DoGetShopsTagsResponse  implements java.io.Serializable {
    ...
    private pl.allegro.webapi.service_php.ShopsTagTypeStruct[] shopsTags;
    ...
    public DoGetShopsTagsResponse(
           int shopsTagsCount,
           pl.allegro.webapi.service_php.ShopsTagTypeStruct[] shopsTags) {
     ...
     * @return shopsTags
     */
    public pl.allegro.webapi.service_php.ShopsTagTypeStruct[] getShopsTags() {
        return shopsTags;
    }
     ...
     * @param shopsTags
     */
    public void setShopsTags(pl.allegro.webapi.service_php.ShopsTagTypeStruct[] shopsTags) {
        this.shopsTags = shopsTags;
    }
